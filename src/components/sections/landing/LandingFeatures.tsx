        ...
        <div className="features-content flex flex-col lg:flex-row gap-12 md:gap-20 mt-14">
          ...
          >
            ...
            >
              ...
              >
                <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/icons/email-icon.svg`} className="w-9" />
              </span>
              <input
                type="text"
              ...
              >
                <button onClick={handleEmailSubmit}>
                  <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/icons/send-icon.svg`} className="w-20" />
                </button>
              </span>
            </div>
          </motion.div>
          ...
          >
            <div className="features-card md:w-1/2 lg:w-2/4 bg-green03 rounded-lg flex flex-col items-center p-8 gap-10 overflow-hidden cursor-pointer">
              ...
              <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/mockup1.svg`} className="width-full" />
            </div>
            <motion.div
              variants={variants.varient2}
              initial="hidden"
            ...
            >
              ...
              <img
                src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/mockup2.png`}
