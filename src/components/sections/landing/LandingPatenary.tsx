...
const LandingPatenary = (): JSX.Element => {
  ...
  return (
    <section
      className="landing__partners pt-24 lg:pt-30 px-8 md:px-16 lg:px-40 bg-white"
      ref={ref}
      id="partners"
    >
      ...
      <div className="container2 w-full flex justify-center">
        <motion.div
          ...
          initial="hidden"
          animate={controls}
          className="partners-content grid grid-cols-2 md:grid-cols-3 mt-14 w-max flex justify-center gap-12 md:gap-20"
        >
          {partnerList.map((item, index) => (
            ...
            >
              <a href={item.link} target="_blank">
                <img
                  src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/icons/${item.img}`}
