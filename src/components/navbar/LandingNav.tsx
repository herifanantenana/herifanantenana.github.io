      ...
      <div className="container lg:mx-auto">
        ...
        >
          <div className="nav-responsive-container flex justify-between px-10 lg:px-20 bg-transparent py-6 md:py-8 bg-transparent">
            {/* logo */}
            <div className="logo">
              <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/logo.svg`} alt="logo" className="w-24 md:w-auto" />
            </div>
            ...
            <div className="menu-items  gap-10 items-center hidden lg:flex">
              ...
              <div className="contact-btn">
                <button className="bg-green02 hover:bg-green01 rounded-3xl py-3 text-white px-6 general-sans-medium" onClick={() => { scrollSection("contact"); changeNav(false) }}>
                  Nous contacter
                </button>
              </div>
            </div>
            ...
            {/* menu icon */}
            <img
              src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/icons/menu-icon.svg`}
              alt=""
