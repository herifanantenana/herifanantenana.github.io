    ...
    return (
        <motion.div variants={variants}
            ...
            <footer
                ...
                <div className="logo">
                    <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/logo.svg`} alt="" />
                </div>
                ...
                <div className="social-icons flex gap-1">
                    <a href="https://www.facebook.com/profile.php?id=61559917253920" target="_blank" rel="noopener noreferrer">
                        <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/icons/fb-icon.svg`} alt="Facebook" className="cursor-pointer" />
                    </a>
                    <a href="https://api.whatsapp.com/send?phone=0345503761" target="_blank" rel="noopener noreferrer">
                        <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/icons/whatsapp-icon.svg`} alt="WhatsApp" className="cursor-pointer" />
                    </a>
                </div>
            </footer>
        </motion.div>
